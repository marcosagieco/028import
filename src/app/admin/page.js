...
export default function AdminPage() {
  const [activeTab, setActiveTab] = useState('historial'); // AHORA LA PESTAÑA PRINCIPAL ES "HISTORIAL"
  ...
  // Solo dejamos la función para eliminar del historial
  const deleteOrder = async (id) => { if (confirm("¿Eliminar este pedido del historial permanentemente?")) { try { await deleteDoc(doc(firebaseRefs.db, 'orders', id)); } catch (err) { alert("Error: " + err.message); } } };

  // Calculamos la recaudación total de todos los pedidos históricos
