...
const initialHomeSections = [
  { id: 'sec_mas_buscados', title: "🔥 MÁS BUSCADOS", icon: 'fa-fire', productIds: [4, 8, 20], order: 1 },
  { id: 'sec_nuevos_ingresos', title: "⚡ NUEVOS INGRESOS", icon: 'fa-bolt', productIds: [18, 28, 29], order: 2 }
];
...
export default function AdminPage() {
  ...
  // --- SINCRONIZACIÓN ACTUALIZADA PARA PRODUCTOS Y VIDRIERA ---
