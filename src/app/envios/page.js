...
export const metadata = {
  ...
  description: 'Logística Premium adaptada a tus necesidades. Envío Flex en el día CABA/GBA y envíos a toda Argentina.',
};
    ...
    <main className="min-h-screen py-16 px-4 md:py-24 bg-[#fafafa]">
      <div className="max-w-3xl mx-auto bg-white p-8 md:p-16 rounded-[2rem] shadow-[0_20px_60px_-15px_rgba(0,0,0,0.05)] border border-gray-100">
        ...
        <div className="space-y-6 text-gray-600 leading-relaxed text-sm md:text-base">
          ...
          {/* Tarjetas de envío idénticas a tu diseño */}
          <div className="bg-gray-50 p-6 rounded-2xl border border-gray-100 my-6prose prose-gray max-w-none">
          ...
          <div className="bg-gray-50 p-6 rounded-2xl border border-gray-100 my-6prose prose-gray max-w-none">
            ...
            <p className="text-sm">Si prefiere gestionar el retiro de manera personal, puede seleccionar esta opción. Una vez preparado el pedido, le informaremos por WhatsApp la dirección exacta (Zona Belgrano) y la franja horaria habilitada.</p>
          </div>
        </div>
